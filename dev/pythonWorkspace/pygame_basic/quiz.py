...
background = pygame.image.load("/Users/tomlee/dev/pythonWorkspace/똥피하기/background.png")

#character
character = pygame.image.load("/Users/tomlee/dev/pythonWorkspace/똥피하기/character.png")
...
characterYPos = screenHeight - (characterHeight + 20)
characterSpeed = 0.4

#enemy
enemy = pygame.image.load("/Users/tomlee/dev/pythonWorkspace/똥피하기/enemy.png")
